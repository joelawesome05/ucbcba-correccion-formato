...
class StepBibliography extends Component {
    constructor(props) {
        super(props);
    }
        ...
        if (this.props.noBiography) {
            inputs = (
                <fieldset disabled>
                    ...
                    <div className="leftForm">
                        <label className="myLabel">Referencia bibliográfica:</label>
                        <select name="bibliograhyType" >
            ...
            inputs = (
                <div>
                    ...
                    <div className="leftForm">
                        <label className="myLabel">Referencia bibliográfica:</label>
                        <select name="bibliograhyType" value={this.props.bibliograhyType} onChange={this.props.handleChange}>
                            <option value="UCB">UCB</option>
                            <option value="APA">APA 6ta edición</option>
...
export default StepBibliography;
