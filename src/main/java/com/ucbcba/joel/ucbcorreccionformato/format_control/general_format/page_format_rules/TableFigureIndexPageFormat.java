...
public class TableFigureIndexPageFormat implements PageFormatRule {
    private PDDocument pdfdocument;
    private AtomicLong idHighlights;
    private int pageStart;
    private String indexName;

    public TableFigureIndexPageFormat(PDDocument pdfdocument, AtomicLong idHighlights, int pageStart, String indexName){
